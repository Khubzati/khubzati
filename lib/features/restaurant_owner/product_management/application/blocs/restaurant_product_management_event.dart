...
class LoadRestaurantProductCategories extends RestaurantProductManagementEvent {
  const LoadRestaurantProductCategories();
}
...
class UploadRestaurantProductImages extends RestaurantProductManagementEvent {
  final String productId;
  final List<String> imageFiles;

  const UploadRestaurantProductImages({
    required this.productId,
...
class DeleteRestaurantProductImage extends RestaurantProductManagementEvent {
  final String productId;
  final String imageId;

  const DeleteRestaurantProductImage({
    required this.productId,
